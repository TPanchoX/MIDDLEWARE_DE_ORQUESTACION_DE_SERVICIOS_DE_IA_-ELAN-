...
\section*{\normalfont ANEXO A. Esquema completo del archivo manifest.json}
\addcontentsline{toc}{section}{ANEXO A. Esquema completo del archivo manifest.json}
...
\section*{\normalfont ANEXO B. Ejemplo completo de respuesta JSON de inferencia}
\addcontentsline{toc}{section}{ANEXO B. Ejemplo completo de respuesta JSON de inferencia}
...
\section*{\normalfont ANEXO C. Configuración del docker-compose.yml del middleware}
\addcontentsline{toc}{section}{ANEXO C. Configuración del docker-compose.yml del middleware}
...
\section*{\normalfont ANEXO D. Compilación e integración del reconocedor en ELAN 7.1}
\addcontentsline{toc}{section}{ANEXO D. Compilación e integración del reconocedor en ELAN 7.1}
